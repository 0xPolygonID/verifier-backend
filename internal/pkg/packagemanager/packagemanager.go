...
// NewPackageManager  is a constructor for the package manager
func NewPackageManager(
	supportedRPC map[string]string,
	supportedStateContracts map[string]string,
	opts ...Option,
) (*iden3comm.PackageManager, error) {
	const globalStateValidDuration = 15 * time.Minute

	options := &Options{
		VerificationKeyPath:      "/keys",
		GlobalStateValidDuration: globalStateValidDuration,
	}
